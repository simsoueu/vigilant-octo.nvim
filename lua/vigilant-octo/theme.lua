...
local colors = require("vigilant-octo.colors")
...
function M.setup()
  ...
  theme.highlights = {
    ...
    Normal = { fg = c.blue100, bg = options.transparent and c.none or c.bg }, -- normal text
    ...
    Statement = { fg = c.yellow500 }, -- (preferred) any statement
