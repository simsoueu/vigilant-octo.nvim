local ts = require("vigilant-octo.treesitter")
...
function M.invert_color(color)
  local hsluv = require("vigilant-octo.hsluv")
  if color ~= "NONE" then
...
function M.autocmds(config)
  local group = vim.api.nvim_create_augroup("vigilant-octo", { clear = true })
...
function M.load(theme)
  ...
  vim.g.colors_name = "vigilant-octo"
