...
function M.setup()
  ...
  for extra, info in pairs(M.extras) do
    package.loaded["vigilant-octo.extra." .. extra] = nil
    local plugin = require("vigilant-octo.extra." .. extra)
    for style, style_name in pairs(styles) do
      config.setup({ style = style })
      local colors = require("vigilant-octo.colors").setup({ transform = true })
